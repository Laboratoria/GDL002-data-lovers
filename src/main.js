...
const loadYear = () => { 
    const yrSelector = document.getElementById("year"); // Declarar una variable para que me genere el rango de los años automaticamente en mi selector para año 
...
const loadYear2 = () => { 
    const yrSelec = document.getElementById("year-dos"); // Declarar una variable para que me genere el rango de los años automaticamente en mi selector para año 
    for (i = 1960; i <= 2017 ; i++) { // Implementar el ciclo para indicar los años
